...
import hoverSound from './assets/audio/dawg2.mp4';
...
function ImageRecognizerComponent3() {
    ...
    async function recognizeImage() {
        ...
        try {
            ...
            document.getElementById('i3').value = classLabels[predictedIndex];
            if (predictedIndex == 0){
    ...
    return (
        <div className="centered-heading">
            ...
            <input id="i3" onMouseEnter={playAudio} type="text"  readOnly />
        </div>
    );
}

...
import hoverSound from './assets/audio/dawg3.mp4';
...
function ImageRecognizerComponent4() {
    ...
    async function recognizeImage() {
        ...
        try {
            ...
            document.getElementById('i4').value = classLabels[predictedIndex];
            if (predictedIndex == 0){
    ...
    return (
        <div className="centered-heading">
            ...
            <input id="i4" onMouseEnter={playAudio} type="text"  readOnly />
        </div>
    );
}
